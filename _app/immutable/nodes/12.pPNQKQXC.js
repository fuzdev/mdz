import"../chunks/DsnmJJEf.js";import{o as He,s as N}from"../chunks/CPn_qVAu.js";import{p as Ge,an as z,aB as ne,b as Je,f as l,d as p,s as t,am as P,r as u,bz as Xe,k as e,a as d,l as Ke,t as $e,bq as x,ao as i,I as Qe,br as Ye,c as L,bB as Se}from"../chunks/Of7XdXlS.js";import{i as Ze}from"../chunks/BNt4ZQXs.js";import{e as E,r as Me,s as et,f as tt}from"../chunks/YG32Cggc.js";import{b as Te}from"../chunks/CvMdrhHs.js";import{C as q}from"../chunks/DkBsXLcM.js";import{c as nt}from"../chunks/C9u-2Ple.js";import{T as at}from"../chunks/D2itI5pA.js";import{T as m,a as h}from"../chunks/6SfDk3vl.js";import{D as V}from"../chunks/CQQFcfec.js";import{T as st}from"../chunks/B0WyeaN2.js";import{D as rt}from"../chunks/0rnIDeBE.js";import{D as ot}from"../chunks/HNOTeoU1.js";import{M as g}from"../chunks/D2DOafAV.js";import{M as ae,a as se,b as it}from"../chunks/DPt79OxL.js";import{M as dt}from"../chunks/CiGU8ORl.js";const ct=`mdz ships three ways to turn \`.mdz\` text into a rendered tree. Pick based on whether content is static, available all-at-once, or streaming.
...
(stream done)`,W=20;let _=z(Oe),$=z(ne(new ae)),F=z(ne(new se)),o=z(0),S=z(!1),b=z(!1),j=z(100),w=z(ne([])),f;const C=()=>{const y=e($).take_opcodes();y.length!==0&&(e(F).apply_batch(y),i(w,[...e(w),...y.map(re=>JSON.stringify(re))].slice(-W),!0))},Ue=()=>{if(e(o)>=e(_).length){e($).finish(),C(),i(S,!1),i(b,!0),f!==void 0&&(clearInterval(f),f=void 0);return}e($).feed(e(_)[e(o)]),C(),Se(o)},H=()=>{e(b)&&G(),i(S,!0),f=setInterval(Ue,e(j))},A=()=>{i(S,!1),f!==void 0&&(clearInterval(f),f=void 0)},G=()=>{A(),i($,new ae,!0),i(F,new se,!0),i(o,0),i(b,!1),i(w,[],!0)},J=y=>{for(A(),y<e(o)&&(i($,new ae,!0),i(F,new se,!0),i(o,0),i(b,!1),i(w,[],!0));e(o)<y&&e(o)<e(_).length;)e($).feed(e(_)[e(o)]),Se(o);C(),e(o)>=e(_).length&&!e(b)&&(e($).finish(),C(),i(b,!0))};He(()=>()=>{f!==void 0&&clearInterval(f)}),dt(Pe,{get code(){return ot},get codeblock(){return q},children:(y,re)=>{at(y,{get tome(){return Ae},children:(Ie,xt)=>{var oe=yt(),X=l(oe),ie=p(X),de=t(p(ie),3);st(de,{slug:"usage"});var ce=t(de,2);V(ce,{name:"MdzStreamParser"});var le=t(ce,2);V(le,{name:"MdzStreamState"});var Ee=t(le,2);V(Ee,{name:"MdzStream"}),P(7),u(ie),u(X);var pe=t(X,2);m(pe,{children:(r,v)=>{var n=bt(),a=l(n);h(a,{text:"Demo"});var s=t(a,4);Xe(s),E(s,"",{},{height:"300px"});var O=t(s,2),T=p(O);E(T,"",{},{width:"85px"});var K=p(T,!0);u(T);var Q=t(T,2),Y=t(Q,2),Z=t(Y,2),be=t(Z,2),R=p(be);Me(R);var je=t(R);u(be),u(O);var ee=t(O,2),B=p(ee);E(B,"",{},{width:"50px","text-align":"right"});var Ce=t(p(B),2);u(B);var U=t(B,2);Me(U),E(U,"",{},{flex:"1"}),u(ee);var D=t(ee,2);E(D,"",{},{"min-height":"300px"});var Re=p(D);{var Be=c=>{var M=gt(),I=t(p(M));P(),u(M),x("click",I,()=>e(S)?A():H()),d(c,M)},De=c=>{it(c,{get stream(){return e(F)}})};Ze(Re,c=>{e(o)===0?c(Be):c(De,-1)})}u(D);var we=t(D,2);rt(we,{summary:M=>{P();var I=Qe();$e(()=>N(I,`opcodes (${(e(w).length===W?`last ${W}`:e(w).length)??""})`)),d(M,I)},children:(M,I)=>{var ze=kt(),te=l(ze),xe=t(p(te));V(xe,{name:"MdzStreamParser"});var qe=t(xe);qe.nodeValue=` can emit zero or more opcodes.
					This shows the most recent 20: watch `,P(10),u(te);var Ve=t(te,2);{let We=Ke(()=>e(w).length===0?"(no opcodes yet)":[...e(w)].reverse().join(`
...
stream<span class="token_punctuation">.</span><span class="token_function">apply_batch</span><span class="token_punctuation">(</span>parser<span class="token_punctuation">.</span><span class="token_function">take_opcodes</span><span class="token_punctuation">(</span><span class="token_punctuation">)</span><span class="token_punctuation">)</span><span class="token_punctuation">;</span>`});var Ne=t(ye,2);q(Ne,{dangerous_raw_html:'<span class="token_tag"><span class="token_tag"><span class="token_punctuation token_tag_punctuation">&lt;</span>MdzStream</span> <span class="token_svelte_expression"><span class="token_punctuation">{</span><span class="token_lang_ts">stream</span><span class="token_punctuation">}</span></span> <span class="token_punctuation token_tag_punctuation">/></span></span>'}),$e(()=>{N(K,e(S)?"pause":e(b)?"restart":"stream"),Q.disabled=e(o)===0,Y.disabled=e(o)===0,Z.disabled=e(b),N(je,` ${e(j)??""}ms`),N(Ce,` ${e(o)??""}/${e(_).length??""}`),et(U,"max",e(_).length),tt(U,e(o))}),x("input",s,G),Te(s,()=>e(_),c=>i(_,c)),x("click",T,()=>e(S)?A():H()),x("click",Q,G),x("click",Y,()=>J(e(o)-1)),x("click",Z,()=>J(e(o)+1)),x("input",R,()=>{e(S)&&(A(),H())}),Te(R,()=>e(j),c=>i(j,c)),x("input",U,c=>J(+c.currentTarget.value)),d(r,n)},$$slots:{default:!0}});var ue=t(pe,2);m(ue,{children:(r,v)=>{var n=k(),a=l(n);h(a,{text:"Three rendering paths"});var s=t(a,2);g(s,{get content(){return ct}}),d(r,n)},$$slots:{default:!0}});var me=t(ue,2);m(me,{children:(r,v)=>{var n=k(),a=l(n);h(a,{text:"Picking a path"});var s=t(a,2);g(s,{get content(){return lt}}),d(r,n)},$$slots:{default:!0}});var he=t(me,2);m(he,{children:(r,v)=>{var n=k(),a=l(n);h(a,{text:"Opcode design"});var s=t(a,2);g(s,{get content(){return pt}}),d(r,n)},$$slots:{default:!0}});var _e=t(he,2);m(_e,{children:(r,v)=>{var n=k(),a=l(n);h(a,{text:"Why wrap exists",children:(O,T)=>{P();var K=wt();P(2),d(O,K)},$$slots:{default:!0}});var s=t(a,2);g(s,{get content(){return ut}}),d(r,n)},$$slots:{default:!0}});var fe=t(_e,2);m(fe,{children:(r,v)=>{var n=k(),a=l(n);h(a,{text:"Determinism and chunk boundaries"});var s=t(a,2);g(s,{get content(){return mt}}),d(r,n)},$$slots:{default:!0}});var ve=t(fe,2);m(ve,{children:(r,v)=>{var n=k(),a=l(n);h(a,{text:"Append-only invariant"});var s=t(a,2);g(s,{get content(){return ht}}),d(r,n)},$$slots:{default:!0}});var ge=t(ve,2);m(ge,{children:(r,v)=>{var n=k(),a=l(n);h(a,{text:"Consumers"});var s=t(a,2);g(s,{get content(){return _t}}),d(r,n)},$$slots:{default:!0}});var ke=t(ge,2);m(ke,{children:(r,v)=>{var n=k(),a=l(n);h(a,{text:"Limitations"});var s=t(a,2);g(s,{get content(){return ft}}),d(r,n)},$$slots:{default:!0}});var Fe=t(ke,2);m(Fe,{children:(r,v)=>{var n=k(),a=l(n);h(a,{text:"See also"});var s=t(a,2);g(s,{get content(){return vt}}),d(r,n)},$$slots:{default:!0}}),d(Ie,oe)},$$slots:{default:!0}})},$$slots:{default:!0}}),Je()}Ye(["input","click"]);export{Nt as component};
