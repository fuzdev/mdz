import"../chunks/DsnmJJEf.js";import{o as He,s as N}from"../chunks/ke3ZzJ1N.js";import{p as Ge,an as z,aB as ne,b as Je,f as c,d as p,s as t,am as P,r as m,bz as Xe,k as e,a as d,l as Ke,t as $e,bq as x,ao as i,I as Qe,br as Ye,c as L,bB as Se}from"../chunks/DYR17mJS.js";import{i as Ze}from"../chunks/HUkRvC-9.js";import{e as E,r as Me,s as et,f as tt}from"../chunks/BG1Swqwb.js";import{b as Te}from"../chunks/CTvZx0I5.js";import{C as q}from"../chunks/-ny32vvx.js";import{c as nt}from"../chunks/dy1rgG0J.js";import{T as at}from"../chunks/CodBFs6t.js";import{T as u,a as h}from"../chunks/Bsyq8xpM.js";import{D as V}from"../chunks/2bWsAnOJ.js";import{T as st}from"../chunks/D-aOzsEn.js";import{D as rt}from"../chunks/BRCRZ8q0.js";import{D as ot}from"../chunks/yr1iZdOn.js";import{M as g}from"../chunks/BsqWkuUO.js";import{M as ae,a as se,b as it}from"../chunks/uCsKkGjN.js";import{M as dt}from"../chunks/DkmlEArR.js";const lt=`mdz ships three ways to turn \`.mdz\` text into a rendered tree. Pick based on whether content is static, available all-at-once, or streaming.
...
`,_t="mdz ships two opcode consumers:\n\n- `mdz_opcodes_to_nodes(opcodes)` — replays an opcode array into the same `MdzNode[]` tree that `mdz_parse` produces. Used by tests to assert parity. Useful when you want the static tree shape but already have opcodes (e.g. cached from an earlier stream).\n\n- `MdzStreamState` — applies opcodes to a reactive Svelte 5 tree of `MdzStreamNode` instances. Each node's `content`, `children`, and metadata fields are `$state`, so Svelte updates only what changed. `MdzStream` renders the tree.\n\nThe two consumers' outputs are structurally equivalent (parity tests assert this). `MdzStreamState` is built for fine-grained reactivity and keeps per-id node identity for granular updates, so it skips a couple of tidies (adjacent-Text merging, single-tag paragraph unwrap) that `mdz_opcodes_to_nodes` applies at tree-build time.\n",ft="- **Residual divergences under adversarial input**, as documented above — italic-bounded and unclosed code spans under adversarial chunking, link/tag syntax held into EOF, and column-0 block lines interrupting paragraphs spanned by an optimistic inline.\n- **Opcode stream order varies with chunking**, but the final tree does not.\n- **No partial-revert** — once a container closes, it's committed. Mid-render edits aren't supported.\n- **Single-pass** — backtracking would defeat the streaming guarantee. Ambiguous syntax (e.g. unclosed `[`) renders as visible text via revert rather than re-parsing.\n- **A table's header holds one line** — a pipe row (`| a | b |`) renders only once its delimiter row (`| - | - |`) arrives, the bounded lookahead that tells a table from a paragraph of literal pipes; body rows then stream one per line. This is intentional, not a stall: there's no useful partial render of a header before it's known to be a table.\n",vt="- `MdzStreamParser` — the parser class\n- `MdzStreamState` — reactive consumer\n- `mdz_opcodes_to_nodes` — tree consumer\n- `MdzOpcode` — opcode type union\n- /docs/usage/grammar — formal grammar for the dialect\n";var gt=L('<p class="color_d_50">(press <button type="button" class="inline color_d sm">stream</button> to begin)</p>'),kt=L(`<p>Each character fed to <!> <code>open</code>, <code>text</code>, <code>close</code> sequences form, and <code>revert</code> when an
				...
				content upfront. For content that arrives incrementally (e.g. from an LLM), use <!> with <!> and <!>. The parser emits opcodes as rendering instructions
				...
				this <a href="https://bsky.app/profile/pngwn.at/post/3mi527zntb22n">Bluesky thread</a> (<a href="https://pngwn.at/">pngwn.at</a>), which originated the approach mdz implements:
				...
				instead of a tree.</p></section> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!>`,1);function Nt(Pe,Le){Ge(Le,!0);const Ae=nt("streaming"),Oe=`Streaming renders **bold text** as bold **immediately**, same with _italic_ and ~~strikethrough~~.
...
(stream done)`,W=20;let _=z(Oe),$=z(ne(new ae)),F=z(ne(new se)),o=z(0),S=z(!1),b=z(!1),j=z(100),w=z(ne([])),f;const C=()=>{const y=e($).take_opcodes();y.length!==0&&(e(F).apply_batch(y),i(w,[...e(w),...y.map(re=>JSON.stringify(re))].slice(-W),!0))},Ue=()=>{if(e(o)>=e(_).length){e($).finish(),C(),i(S,!1),i(b,!0),f!==void 0&&(clearInterval(f),f=void 0);return}e($).feed(e(_)[e(o)]),C(),Se(o)},H=()=>{e(b)&&G(),i(S,!0),f=setInterval(Ue,e(j))},A=()=>{i(S,!1),f!==void 0&&(clearInterval(f),f=void 0)},G=()=>{A(),i($,new ae,!0),i(F,new se,!0),i(o,0),i(b,!1),i(w,[],!0)},J=y=>{for(A(),y<e(o)&&(i($,new ae,!0),i(F,new se,!0),i(o,0),i(b,!1),i(w,[],!0));e(o)<y&&e(o)<e(_).length;)e($).feed(e(_)[e(o)]),Se(o);C(),e(o)>=e(_).length&&!e(b)&&(e($).finish(),C(),i(b,!0))};He(()=>()=>{f!==void 0&&clearInterval(f)}),dt(Pe,{get code(){return ot},get codeblock(){return q},children:(y,re)=>{at(y,{get tome(){return Ae},children:(Ie,xt)=>{var oe=yt(),X=c(oe),ie=p(X),de=t(p(ie),3);st(de,{slug:"usage"});var le=t(de,2);V(le,{name:"MdzStreamParser"});var ce=t(le,2);V(ce,{name:"MdzStreamState"});var Ee=t(ce,2);V(Ee,{name:"MdzStream"}),P(7),m(ie),m(X);var pe=t(X,2);u(pe,{children:(r,v)=>{var n=bt(),a=c(n);h(a,{text:"Demo"});var s=t(a,4);Xe(s),E(s,"",{},{height:"300px"});var O=t(s,2),T=p(O);E(T,"",{},{width:"85px"});var K=p(T,!0);m(T);var Q=t(T,2),Y=t(Q,2),Z=t(Y,2),be=t(Z,2),R=p(be);Me(R);var je=t(R);m(be),m(O);var ee=t(O,2),B=p(ee);E(B,"",{},{width:"50px","text-align":"right"});var Ce=t(p(B),2);m(B);var U=t(B,2);Me(U),E(U,"",{},{flex:"1"}),m(ee);var D=t(ee,2);E(D,"",{},{"min-height":"300px"});var Re=p(D);{var Be=l=>{var M=gt(),I=t(p(M));P(),m(M),x("click",I,()=>e(S)?A():H()),d(l,M)},De=l=>{it(l,{get stream(){return e(F)}})};Ze(Re,l=>{e(o)===0?l(Be):l(De,-1)})}m(D);var we=t(D,2);rt(we,{summary:M=>{P();var I=Qe();$e(()=>N(I,`opcodes
					(${(e(w).length===W?`last ${W}`:e(w).length)??""})`)),d(M,I)},children:(M,I)=>{var ze=kt(),te=c(ze),xe=t(p(te));V(xe,{name:"MdzStreamParser"});var qe=t(xe);qe.nodeValue=` can emit zero or more
					opcodes. This shows the most recent 20: watch `,P(10),m(te);var Ve=t(te,2);{let We=Ke(()=>e(w).length===0?"(no opcodes yet)":[...e(w)].reverse().join(`
`));q(Ve,{lang:"json",get content(){return e(We)}})}d(M,ze)},$$slots:{summary:!0,default:!0}});var ye=t(we,2);q(ye,{lang:"ts",dangerous_raw_html:`<span class="token_special_keyword">import</span> <span class="token_punctuation">{</span><span class="token_capitalized_identifier token_class_name">MdzStreamParser</span><span class="token_punctuation">}</span> <span class="token_special_keyword">from</span> <span class="token_string">'@fuzdev/mdz/mdz_stream_parser.js'</span><span class="token_punctuation">;</span>
...
<span class="token_keyword">const</span> parser <span class="token_operator">=</span> <span class="token_keyword">new</span> <span class="token_class_name">MdzStreamParser</span><span class="token_punctuation">();</span>
<span class="token_keyword">const</span> stream <span class="token_operator">=</span> <span class="token_keyword">new</span> <span class="token_class_name">MdzStreamState</span><span class="token_punctuation">();</span>

<span class="token_comment">// feed chunks as they arrive</span>
parser<span class="token_punctuation">.</span><span class="token_function">feed</span><span class="token_punctuation">(</span>chunk<span class="token_punctuation">);</span>
stream<span class="token_punctuation">.</span><span class="token_function">apply_batch</span><span class="token_punctuation">(</span>parser<span class="token_punctuation">.</span><span class="token_function">take_opcodes</span><span class="token_punctuation">());</span>

<span class="token_comment">// when done</span>
parser<span class="token_punctuation">.</span><span class="token_function">finish</span><span class="token_punctuation">();</span>
stream<span class="token_punctuation">.</span><span class="token_function">apply_batch</span><span class="token_punctuation">(</span>parser<span class="token_punctuation">.</span><span class="token_function">take_opcodes</span><span class="token_punctuation">());</span>`});var Ne=t(ye,2);q(Ne,{dangerous_raw_html:'<span class="token_tag"><span class="token_tag"><span class="token_punctuation token_tag_punctuation">&lt;</span>MdzStream</span> <span class="token_svelte_expression"><span class="token_punctuation">{</span><span class="token_lang_ts">stream</span><span class="token_punctuation">}</span></span> <span class="token_punctuation token_tag_punctuation">/></span></span>'}),$e(()=>{N(K,e(S)?"pause":e(b)?"restart":"stream"),Q.disabled=e(o)===0,Y.disabled=e(o)===0,Z.disabled=e(b),N(je,` ${e(j)??""}ms`),N(Ce,` ${e(o)??""}/${e(_).length??""}`),et(U,"max",e(_).length),tt(U,e(o))}),x("input",s,G),Te(s,()=>e(_),l=>i(_,l)),x("click",T,()=>e(S)?A():H()),x("click",Q,G),x("click",Y,()=>J(e(o)-1)),x("click",Z,()=>J(e(o)+1)),x("input",R,()=>{e(S)&&(A(),H())}),Te(R,()=>e(j),l=>i(j,l)),x("input",U,l=>J(+l.currentTarget.value)),d(r,n)},$$slots:{default:!0}});var me=t(pe,2);u(me,{children:(r,v)=>{var n=k(),a=c(n);h(a,{text:"Three rendering paths"});var s=t(a,2);g(s,{get content(){return lt}}),d(r,n)},$$slots:{default:!0}});var ue=t(me,2);u(ue,{children:(r,v)=>{var n=k(),a=c(n);h(a,{text:"Picking a path"});var s=t(a,2);g(s,{get content(){return ct}}),d(r,n)},$$slots:{default:!0}});var he=t(ue,2);u(he,{children:(r,v)=>{var n=k(),a=c(n);h(a,{text:"Opcode design"});var s=t(a,2);g(s,{get content(){return pt}}),d(r,n)},$$slots:{default:!0}});var _e=t(he,2);u(_e,{children:(r,v)=>{var n=k(),a=c(n);h(a,{text:"Why wrap exists",children:(O,T)=>{P();var K=wt();P(2),d(O,K)},$$slots:{default:!0}});var s=t(a,2);g(s,{get content(){return mt}}),d(r,n)},$$slots:{default:!0}});var fe=t(_e,2);u(fe,{children:(r,v)=>{var n=k(),a=c(n);h(a,{text:"Determinism and chunk boundaries"});var s=t(a,2);g(s,{get content(){return ut}}),d(r,n)},$$slots:{default:!0}});var ve=t(fe,2);u(ve,{children:(r,v)=>{var n=k(),a=c(n);h(a,{text:"Append-only invariant"});var s=t(a,2);g(s,{get content(){return ht}}),d(r,n)},$$slots:{default:!0}});var ge=t(ve,2);u(ge,{children:(r,v)=>{var n=k(),a=c(n);h(a,{text:"Consumers"});var s=t(a,2);g(s,{get content(){return _t}}),d(r,n)},$$slots:{default:!0}});var ke=t(ge,2);u(ke,{children:(r,v)=>{var n=k(),a=c(n);h(a,{text:"Limitations"});var s=t(a,2);g(s,{get content(){return ft}}),d(r,n)},$$slots:{default:!0}});var Fe=t(ke,2);u(Fe,{children:(r,v)=>{var n=k(),a=c(n);h(a,{text:"See also"});var s=t(a,2);g(s,{get content(){return vt}}),d(r,n)},$$slots:{default:!0}}),d(Ie,oe)},$$slots:{default:!0}})},$$slots:{default:!0}}),Je()}Ye(["input","click"]);export{Nt as component};
